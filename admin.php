...
<div class="contenido-admin">
    ...
    <div id="productos" class="seccion activo">
        ...
        <div id="form-nuevo-producto" style="display:none; margin-top:20px;">
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='php/delete_producto.php?id={$row['id_producto']}' class='btn-delete' onclick='return confirm(\"¿Eliminar este producto?\")'>
